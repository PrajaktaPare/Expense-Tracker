...
export default function Budget() {
  ...
  const handleSaveBudget = () => {
    updateBudget(Number.parseFloat(newBudget))
  ...
  const handleSaveCategoryBudget = (categoryId) => {
    ...
    updateCategory(categoryId, { budget: Number.parseFloat(category.budget) })
  ...
  const handleCategoryBudgetChange = (categoryId, value) => {
    ...
    // This is a bit of a hack since we're not using a proper state management system
